...
const Checkout = () => {
    ...
    const verifyPayment = async (orderId) => {
        try {
            ...
            const paymentStatus = res.data[0].payment_status === 'SUCCESS' ? 'success' : 'failed';
    ...
    return (
        <div className="checkout-container">
            ...
            <div className="checkout-section">
                ...
                <input type="text" name="house_detail" value={userData.address.house_detail} onChange={handleInputChange} required />
                ...
                <input type="text" name="areaDetail" value={userData.address.areaDetail} onChange={handleInputChange} required />
                ...
                <input type="text" name="landmark" value={userData.address.landmark} onChange={handleInputChange} required />
                {errors.landmark && <p className="error">{errors.landmark}</p>}

                <label htmlFor="pincode">Pincode <span className="required">*</span></label>
                <input type="text" name="pincode" value={userData.address.pincode} onChange={handleInputChange} required />
